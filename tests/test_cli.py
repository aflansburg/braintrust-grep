...
def test_metadata_specs_to_cli():
    got = cli._metadata_specs_to_cli(
        [{"field": "input.raw_text", "keys": ["pages", "documentdata"]}, "other.field"]
    )
    assert got == ["input.raw_text:pages,documentdata", "other.field"]
